...
s.source           = { :git => "git@git.dseelab.com:ios/module/tool/bmplayer.git", :tag => s.version.to_s }
...
s.subspec 'Full' do |full|
    ...
    full.dependency 'SnapKit', '>= 5.0'
    full.dependency 'NVActivityIndicatorView', '>= 4.7'
end
...
s.subspec 'CacheSupport' do |cache|
    ...
    cache.dependency 'SnapKit', '~> 5.0'
    cache.dependency 'NVActivityIndicatorView', '~> 4.7'
